            ...
            className={css.rightSide}>
                ...
                <div className={`flexCenter ${css.stats}`}>
                    <div className={`flexCenter ${css.stat}`}>
                        <span className='primaryText'>2020-2024</span>
                        <span className='secondaryText'>BIT MESRA</span>
                    </div>
                    <div className={`flexCenter ${css.stat}`}>
                        <span className='primaryText'>EEE</span>
                        <span className='secondaryText'>Electrical and Electronics</span>
                    </div>
                </div>
            </motion.div>
        </motion.div>
